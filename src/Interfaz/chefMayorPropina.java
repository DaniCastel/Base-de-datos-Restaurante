...
public class chefMayorPropina extends javax.swing.JFrame {
    

    
    public chefMayorPropina() {
        initComponents();
    ...
    public void imprimirMenu(){
        try {
            ...
            try {
                ...
                Logger.getLogger(chefMayorPropina.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new chefMayorPropina().setVisible(true);
            }
        });
    }
