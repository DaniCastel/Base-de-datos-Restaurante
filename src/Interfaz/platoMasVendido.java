...
public class platoMasVendido extends javax.swing.JFrame {
    ...
    public void imprimirMenu(){
        try {
            ...
            try {
                ...
                Logger.getLogger(platoMasVendido.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new platoMasVendido().setVisible(true);
            }
        });
    }
