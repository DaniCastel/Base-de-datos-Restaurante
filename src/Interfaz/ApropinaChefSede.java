...
public class ApropinaChefSede extends javax.swing.JFrame {
    

    
    public ApropinaChefSede() {
        initComponents();
    ...
    public void imprimirMenu(){
        try {
            ...
            try {
                ...
                Logger.getLogger(ApropinaChefSede.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApropinaChefSede().setVisible(true);
            }
        });
    }
