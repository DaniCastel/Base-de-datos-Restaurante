...
public class camareroClientesAtendidos extends javax.swing.JFrame {
    

    
    public camareroClientesAtendidos() {
        initComponents();
    ...
    public void imprimirMenu(){
        try {
            ...
            try {
                ...
                Logger.getLogger(camareroClientesAtendidos.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new camareroClientesAtendidos().setVisible(true);
            }
        });
    }
