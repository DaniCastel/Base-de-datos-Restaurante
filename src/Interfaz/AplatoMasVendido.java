...
public class AplatoMasVendido extends javax.swing.JFrame {
    

    
    public AplatoMasVendido() {
        initComponents();
    ...
    public void imprimirMenu(){
        try {
            ...
            try {
                ...
                Logger.getLogger(AplatoMasVendido.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AplatoMasVendido().setVisible(true);
            }
        });
    }
