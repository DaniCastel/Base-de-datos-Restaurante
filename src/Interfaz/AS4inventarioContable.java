...
public class AS4inventarioContable extends javax.swing.JFrame {
    

    
    public AS4inventarioContable() {
        initComponents();
    ...
    public void imprimirMenu(){
        try {
            ...
            try {
                ...
                Logger.getLogger(AS4inventarioContable.class.getName()).log(Level.SEVERE, null, ex);
            }

            Statement st = MySQL.conn.createStatement();
            String sql = "Select * from inventario_contable";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Inventario de insumos por unidades");
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
        try {
            ...
            Statement st = MySQL.conn.createStatement();
            String sql = "Select * from inventario_contable where (inv_ins_sed_id = " + sede.getText() +") " ;
            ResultSet rstb = st.executeQuery(sql);
            ResultSetMetaData rsmd = rstb.getMetaData();
            int col = rsmd.getColumnCount();
            DefaultTableModel modelo = new DefaultTableModel();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AS4inventarioContable().setVisible(true);
            }
        });
    }
