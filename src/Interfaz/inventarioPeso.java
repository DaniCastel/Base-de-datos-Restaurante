...
public class inventarioPeso extends javax.swing.JFrame {
    

    
    public inventarioPeso() {
        initComponents();
    ...
    public void imprimirMenu(){
        try {
            ...
            try {
                ...
                Logger.getLogger(inventarioPeso.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new inventarioPeso().setVisible(true);
            }
        });
    }
