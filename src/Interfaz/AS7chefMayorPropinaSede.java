...
public class AS7chefMayorPropinaSede extends javax.swing.JFrame {
    

    
    public AS7chefMayorPropinaSede() {
        initComponents();
    ...
    public void imprimirMenu(){
        try {
            ...
            try {
                ...
                Logger.getLogger(AS7chefMayorPropinaSede.class.getName()).log(Level.SEVERE, null, ex);
            }
            CallableStatement cStmt;
            cStmt = MySQL.conn.prepareCall("{call proc_propina_chef_sede_may(?)}");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Chef con mayor propina en la sede");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AS7chefMayorPropinaSede().setVisible(true);
            }
        });
    }
