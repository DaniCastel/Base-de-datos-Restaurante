...
public class AGhistorialCompra extends javax.swing.JFrame {
    

    
    public AGhistorialCompra() {
        initComponents();
    ...
    public void imprimirMenu(){
        try {
            ...
            try {
                ...
                Logger.getLogger(AGhistorialCompra.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AGhistorialCompra().setVisible(true);
            }
        });
    }
