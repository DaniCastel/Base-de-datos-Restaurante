...
public class ASchefMayorPropinaSede extends javax.swing.JFrame {
    

    
    public ASchefMayorPropinaSede() {
        initComponents();
    ...
    public void imprimirMenu(){
        try {
            ...
            try {
                ...
                Logger.getLogger(ASchefMayorPropinaSede.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ASchefMayorPropinaSede().setVisible(true);
            }
        });
    }
