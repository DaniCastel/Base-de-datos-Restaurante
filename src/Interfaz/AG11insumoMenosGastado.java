...
public class AG11insumoMenosGastado extends javax.swing.JFrame {
    

    
    public AG11insumoMenosGastado() {
        initComponents();
    ...
    public void imprimirMenu(){
        try {
            ...
            try {
                ...
                Logger.getLogger(AG11insumoMenosGastado.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AG11insumoMenosGastado().setVisible(true);
            }
        });
    }
