...
public class pedidosChef extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMesa.setText("Chef: Pedidos pendientes");
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
        ...
        try {
            ...
            cStmt = conec.prepareCall("{call pc_pedidos_chef(?)}");
            ...
            Logger.getLogger(pedidosChef.class.getName()).log(Level.SEVERE, null, e);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pedidosChef().setVisible(true);
            }
        });
    }
