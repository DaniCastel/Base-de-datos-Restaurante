...
public class AS5nventarioPeso1 extends javax.swing.JFrame {
    

    
    public AS5nventarioPeso1() {
        initComponents();
    ...
    public void imprimirMenu(){
        try {
            ...
            try {
                ...
                Logger.getLogger(AS5nventarioPeso1.class.getName()).log(Level.SEVERE, null, ex);
            }
           
            Statement st = MySQL.conn.createStatement();
            String sql = "Select * from inventario_peso";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Inventario de insumos por peso");
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
        try {
            ...
            String sql = "Select * from inventario_peso where (inv_ins_sed_id = " + sede.getText() +") " ;
            ResultSet rstb = st.executeQuery(sql);
            ResultSetMetaData rsmd = rstb.getMetaData();
            int col = rsmd.getColumnCount();
            DefaultTableModel modelo = new DefaultTableModel();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AS5nventarioPeso1().setVisible(true);
            }
        });
    }
