...
public class AS9propinaCamarero extends javax.swing.JFrame {

    public AS9propinaCamarero() {
        initComponents();
    ...
    public void imprimirMenu() {
        try {
            ...
            try {
                ...
                Logger.getLogger(AS9propinaCamarero.class.getName()).log(Level.SEVERE, null, ex);
            }

            CallableStatement cStmt;
            cStmt = MySQL.conn.prepareCall("{call proc_cam_prop_sede(?)}");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Propinas: Camareros en la sede");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(sede, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AS9propinaCamarero().setVisible(true);
            }
        });
    }
